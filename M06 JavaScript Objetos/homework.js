...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // objetoUsuario = {amigos: [jorge, pedro, ramon]}

   // objetoUsuario.amigos.push(nuevoAmigo); este metodo tmb funciona
...
//       var porcentaje = objetoProducto.porcentajeDeDescuento;
