...
function incrementarPorUno(array) {
   ...
   // Tu código:
      ...
      var arrayIncrementoUno = [];
      for (var i = 0; i < array.length; i++) {
         var elementoUp = array[i] + 1;
         arrayIncrementoUno.push(elementoUp);
      }
      return arrayIncrementoUno;
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var resultado = arrayOfNums.reduce((acumulador, elemento) => acumulador + elemento, 0)
   return resultado;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   var resultado = resultadosTest.reduce((acumulador, i) => acumulador + i, 0);
